...
let allUsers = [
  newUser('Alyssa', 'Morris', 1800.00, 'amorris@gmail.com'),
  newUser('Mindy', 'Weaver', 200.00, 'mweaver@aol.com'),
  newUser('Louis', 'Washington', 850.00, "Hoodfav@yahoo.com"),
  newUser('Kevin', 'Isaacs', 80.00, "kiss@gmail.com"),
];
...
for (let user of allUsers) {
  ...
  if (userCanAffordSofa(user, sofa)) {
    ...
    console.log(`We will be emailing your receipt shortly to ${user[3]}`)
  } else {
